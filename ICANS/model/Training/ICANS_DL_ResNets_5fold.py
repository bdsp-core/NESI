...
# ## **Ordinal Training function helper**
...
def RESNet_kfold_stratified_group(df_ICANS_metadata, base_model_dir , dl_model, n_splits=5, bs=32):
    """
...
model_normal = MORGOTH_ResNet1D_BiLSTM_TimeShuffle(num_features=17, num_classes=3, time_shuffle=False)
base_model_dir = ICANS_ROOT / "model" / "ModelCheckpointsNew" / "RESNET_notimeshift"

RESNet_results_notimeshuffle = RESNet_kfold_stratified_group(df_ICANS_metadata, base_model_dir, model_normal,
                                                        n_splits=5, bs=32)
...
# Time-shuffled model
model_shuffle = MORGOTH_ResNet1D_BiLSTM_TimeShuffle(num_features=17, num_classes=3, time_shuffle=True)
base_model_dir = ICANS_ROOT / "model" / "ModelCheckpointsNew" / "RESNET_TIMESHIFT"

RESNet_results_withtimeshuffle = RESNet_kfold_stratified_group(df_ICANS_metadata, base_model_dir, model_shuffle, 
                                                        n_splits=5, bs=32)
...
# -------------------------------RESNET only GAP----------------------
model_onlygap = MORGOTH_ResNet1D_onlyGAP_CORAL(num_features=17, num_classes=3)

base_model_dir = ICANS_ROOT / "model" / "ModelCheckpointsNew" / "RESNET_GAPonly"

RESNet_results_gaponly = RESNet_kfold_stratified_group(df_ICANS_metadata, base_model_dir, model_onlygap, 
                                                        n_splits=5, bs=32)
