...
"""
Per-EEG ASM and antipsychotic exposure flags for the I0002 GCS cohort.

For patients with NO medication administration records in the patched
pivoted parquet, exposure is set to NA (not 0).
...
def compute_category_exposure(eeg_df, category_name, patients_with_med_data):
    admin_path = med_config.I0002_ASM_ANTIPSYCH_DIR / f"{category_name}_administrations.csv"
...
def main():
    try:
        ...
        print(f"Total I0002 GCS EEG rows: {len(meta):,}")
        ...
        out_path = med_config.I0002_ASM_ANTIPSYCH_DIR / "i0002_per_eeg_asm_antipsych_exposure.csv"
