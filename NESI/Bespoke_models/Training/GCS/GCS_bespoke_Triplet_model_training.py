...
base_model_dir = NSEI_ROOT / "Bespoke_models"/ "ModelCheckpoints_NEW" / "TripletCheckpoint" / "cohort_models" / "GCS" / 
...
# --------- LOAD MODEL ----------
model_path_trained = NSEI_ROOT / "Bespoke_models"/ "ModelCheckpoints_NEW" / "TripletCheckpoint" / "cohort_models" / "GCS" / "ResNetGAP_GCS_BestModel.pth"
...
plot_pacmap_granular(train_pacmap, 
                     ...
                     Yraw_train_trch,
                     train_dataset_names,
                     title="Train GCS BESPOKE PaCMAP")
...
plot_pacmap_granular(val_pacmap, 
                     ...
                     Yraw_val_trch,
                     val_dataset_names,
                     title="Validation GCS BESPOKE PaCMAP")
