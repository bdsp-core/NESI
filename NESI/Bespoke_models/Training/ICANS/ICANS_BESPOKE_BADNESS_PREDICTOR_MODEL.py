...
# --------- LOAD MODEL ----------
model_path_trained = NSEI_ROOT / "Bespoke_models"/ "ModelCheckpoints_NEW" / "TripletCheckpoint" / "ICANS" / "ResNetGAP_ICANS_BestModel.pth"
...
model_bespoke_bdness_path = NSEI_ROOT / "Bespoke_models"/ "ModelCheckpoints_NEW" / "BespokeBadnessCheckpoint" / "ICANS" / "ICANS_Bespoke_Badness_Bet_model.pth"
train_model(
    model=model,
