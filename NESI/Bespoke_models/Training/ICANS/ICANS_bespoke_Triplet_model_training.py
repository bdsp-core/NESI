...
base_model_dir = NSEI_ROOT / "Bespoke_models"/ "ModelCheckpoints_NEW" / "TripletCheckpoint" / "cohort_models" / "ICANS" / 
...
plot_pacmap_granular(train_pacmap, 
                     ...
                     Yraw_train_trch,
                     train_dataset_names,
                     title="Train ICANS BESPOKE PaCMAP")


# ## **Validation static PacMAPS**
...
plot_pacmap_granular(val_pacmap, 
                     ...
                     Yraw_val_trch,
                     val_dataset_names,
                     title="Validation ICANS BESPOKE PaCMAP")
...
plot_pacmap_granular(tst_pacmap, 
                     ...
                     Yraw_tst_trch,
                     tst_dataset_names,
                     title="Test ICANS BESPOKE PaCMAP") 
