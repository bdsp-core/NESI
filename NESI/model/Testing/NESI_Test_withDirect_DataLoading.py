...
#--------------------------------------------------------------
results_dir = NESI_ROOT / "Data"

with open(results_dir / "NESITripletIP_Morgoth_train_data.pkl", "rb") as f:
    X_train_data_global = pickle.load(f)
print("Train data loaded!")

with open(results_dir / "NESITripletIP_Morgoth_val_data.pkl", "rb") as f:
    X_val_data_global = pickle.load(f)
print("Validation data loaded!")

with open(results_dir / "NESITripletIP_Morgoth_test_data.pkl", "rb") as f:
    X_tst_data_global = pickle.load(f)
print("Test data loaded!")


# --------- Load the other metadata stored in the csv file ------------
df_train_metadata_compiled = pd.read_csv(results_dir / "NESI_train_results.csv")
df_val_metadata_compiled   = pd.read_csv(results_dir / "NESI_val_results.csv")
df_tst_metadata_compiled   = pd.read_csv(results_dir / "NESI_test_results.csv")


trn_filenames_global = df_train_metadata_compiled["Filename"].tolist()
train_dataset_names_global = df_train_metadata_compiled["Dataset"].tolist()
Yraw_train_global = df_train_metadata_compiled["TrueScore"].tolist()
Yraw_transformed_train_global = df_train_metadata_compiled["TransformedTrueScore"].tolist()

val_filenames_global = df_val_metadata_compiled["Filename"].tolist()
val_dataset_names_global = df_val_metadata_compiled["Dataset"].tolist()
Yraw_val_global = df_val_metadata_compiled["TrueScore"].tolist()
Yraw_transformed_val_global = df_val_metadata_compiled["TransformedTrueScore"].tolist()

tst_filenames_global = df_tst_metadata_compiled["Filename"].tolist()
tst_dataset_names_global = df_tst_metadata_compiled["Dataset"].tolist()
Yraw_tst_global = df_tst_metadata_compiled["TrueScore"].tolist()
Yraw_transformed_tst_global = df_tst_metadata_compiled["TransformedTrueScore"].tolist()
