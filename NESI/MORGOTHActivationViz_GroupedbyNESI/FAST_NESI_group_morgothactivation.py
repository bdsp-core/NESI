...
fig_bin1_bal = plot_true_rawscore_histograms(df_bin1_bal, "NESI ∈ [-3, -1)\n after balancing data from class (RASS, GCS: proportionwise data filetring)")
plt.show()
...
# In[13]:
##########################################
# IF YOU DONT HAVE MORGOTH ACTIVATIONS DOWNLOADED
#     FROM AWS USE MY PICKLE FILES FOR THE 
#         FILTERRED BALANCED DATA
##########################################
...
import pickle
#------------- Bin -1 NESI: [-3, -1)-------------------------------
save_path_bin1 = NESI_ROOT/ "MORGOTHActivationViz_GroupedbyNESI" / "NESIbin1_data.pkl"

with open(save_path_bin1, "rb") as f:
    data_bin1 = pickle.load(f)

X_bin1 = data_bin1["X_bin1"]
Y_raw_bin1 = data_bin1["Y_raw_bin1"]
dataset_names_bin1 = data_bin1["dataset_names_bin1"]

#------------- Bin -2 NESI: [-1, 1) -------------------------------
save_path_bin2 = NESI_ROOT/ "MORGOTHActivationViz_GroupedbyNESI" / "NESIbin2_data.pkl"

with open(save_path_bin2, "rb") as f:
    data_bin2 = pickle.load(f)

X_bin2 = data_bin2["X_bin2"]
Y_raw_bin2 = data_bin2["Y_raw_bin2"]
dataset_names_bin2 = data_bin2["dataset_names_bin2"]

save_path_bin3 = NESI_ROOT/ "MORGOTHActivationViz_GroupedbyNESI" / "NESIbin3_data.pkl"

with open(save_path_bin3, "rb") as f:
    data_bin3 = pickle.load(f)

#------------- Bin -3 NESI: [1, 3] -------------------------------
X_bin3 = data_bin3["X_bin3"]
Y_raw_bin3 = data_bin3["Y_raw_bin3"]
dataset_names_bin3 = data_bin3["dataset_names_bin3"]
...
mild_nesi_savepath = NESI_ROOT / "MORGOTHActivationViz_GroupedbyNESI" / "MildNESIMorgothActivation.png"
...
moderate_nesi_savepath = NESI_ROOT / "MORGOTHActivationViz_GroupedbyNESI" / "ModerateNESIMorgothActivation(-1,1).png"
...
worst_nesi_savepath = NESI_ROOT / "MORGOTHActivationViz_GroupedbyNESI" / "WorstNESIMorgothActivation(1, 3).png"
