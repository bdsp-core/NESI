...
SVM_fold_results_median = load_pickle(RESULTS_DIR / "SVM_5fld_median_Results_8class.pkl")
SVM_fold_results_mean   = load_pickle(RESULTS_DIR / "SVM_5fld_mean_Results_8class.pkl")
SVM_fold_results_covupper = load_pickle(RESULTS_DIR / "SVM_5fld_covar_Results_8class.pkl")

LR_fold_results_median = load_pickle(RESULTS_DIR / "LR_5fld_median_Results_8class.pkl")
LR_fold_results_mean   = load_pickle(RESULTS_DIR / "LR_5fld_mean_Results_8class.pkl")
LR_fold_results_covupper = load_pickle(RESULTS_DIR / "LR_5fld_covar_Results_8class.pkl")

KNN_fold_results_median = load_pickle(RESULTS_DIR / "KNN_5fld_median_Results_8class.pkl")
KNN_fold_results_mean   = load_pickle(RESULTS_DIR / "KNN_5fld_mean_Results_8class.pkl")
KNN_fold_results_covupper = load_pickle(RESULTS_DIR / "KNN_5fld_covar_Results_8class.pkl")

RESNET_noshuffle  = load_pickle(RESULTS_DIR / "RESNET_5foldNOSHUFFLE_Results_8class.pkl")
RESNET_withshuffle = load_pickle(RESULTS_DIR / "RESNET_5foldTIMESHUFFLE_Results_8class.pkl")
RESNET_onlyGAP    = load_pickle(RESULTS_DIR / "RESNET_5foldOnlyGap_Results_8class.pkl")
    ...
    for i, fold in enumerate(fold_results):
        ...
        if mode in ["normalized", "both"]:
            ...
            sns.heatmap(cm_percent, annot=True, fmt=".1f", cmap="Blues",
                        ...
                        xticklabels=class_labels,
                        yticklabels=class_labels,
                        annot_kws={"size": font_size2},
                        ax=ax)

            ax.set_title(f"Fold {i+1} (%)", fontsize=font_size+2)
            ax.set_xlabel("Predicted", fontsize=font_size2)
            ax.set_ylabel("True", fontsize=font_size2)
...
# # **MAE per class all models for 8 class**
...
def plot_mae_bar_with_ci(results_list, model_names, num_classes):
    ...
    width = 0.7 / n_models   # 🔥 smaller width → more gap
