...
# # **Load S0002 GCS tables and combine them**
...
s0002_GCS_datapath = GCS_ROOT / "Cohort" / "GCS_BWH_HarvardEEG_metadata.csv" 
df_s0002=pd.read_csv(s0002_GCS_datapath)
...
# Save the paths
# with open("/home/ayush/Desktop/GitHub-YAMA/GCS/Cohort/BWH_GCS_download_AWS.txt", "w") as f:
#     for p in all_paths:
#         f.write(p + "\n")
